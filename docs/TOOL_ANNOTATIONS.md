...
Restoration uses the original calendar identifier, not its title. Two accounts can contain the same calendar name. If the recorded calendar no longer resolves, undo fails and retains the record rather than restoring into another account.
