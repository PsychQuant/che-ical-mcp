# recurrence-read-formats Specification

## Purpose

TBD - created by archiving change 'distinguish-recurrence-read-formats'. Update Purpose after archive.
...
<!-- @trace
source: distinguish-recurrence-read-formats
updated: 2026-09-09
code:
  - Tests/CheICalMCPTests/RecurrenceReadFormatTests.swift
  - CHANGELOG.md
  - README.md
  - docs/REMINDER_RECURRENCE.md
  - README_zh-TW.md
  - Sources/CheICalMCP/ReminderRecurrence.swift
  - Sources/CheICalMCP/Server.swift
  - Sources/CheICalMCP/Validation.swift
  - Sources/CheICalMCP/EventFormattingSource.swift
-->
